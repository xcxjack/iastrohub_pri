...
<input type="button" value="XCX" onClick="javascript: default_XCX();" style="background-color:#000000; color:#FF0000">
<p>
Set Network SSID: 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="Upload Status" onClick="javascript: upload_getStatus();" style="background-color:#000000; color:#FF0000">
<p>
